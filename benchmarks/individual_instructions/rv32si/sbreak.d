...
rv32si/sbreak.elf:     file format elf32-littleriscv
...
01000040 <reset_vector>:
 ...
 10000b4:	07828293          	addi	x5,x5,120 # 1000128 <stvec_handler>
...
01000102 <do_break>:
 1000102:	9002                	c.ebreak
 1000104:	a019                	c.j	100010a <fail>
 1000106:	00301b63          	bne	x0,x3,100011c <pass>

0100010a <fail>:
 100010a:	0ff0000f          	fence	iorw,iorw
 100010e:	00018063          	beq	x3,x0,100010e <fail+0x4>
 1000112:	0186                	c.slli	x3,0x1
 1000114:	0011e193          	ori	x3,x3,1
 1000118:	00000073          	ecall

0100011c <pass>:
 100011c:	0ff0000f          	fence	iorw,iorw
 1000120:	4185                	c.li	x3,1
 1000122:	00000073          	ecall
 1000126:	0001                	c.addi	x0,0

01000128 <stvec_handler>:
 1000128:	430d                	c.li	x6,3
 100012a:	142022f3          	csrrs	x5,scause,x0
 100012e:	fc629ee3          	bne	x5,x6,100010a <fail>
 1000132:	00000317          	auipc	x6,0x0
 1000136:	fd030313          	addi	x6,x6,-48 # 1000102 <do_break>
 100013a:	141022f3          	csrrs	x5,sepc,x0
 100013e:	fc6296e3          	bne	x5,x6,100010a <fail>
 1000142:	bfe9                	c.j	100011c <pass>
	...
