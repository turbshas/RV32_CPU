...
rv32si/scall.elf:     file format elf32-littleriscv
...
01000040 <reset_vector>:
 ...
 10000b4:	09428293          	addi	x5,x5,148 # 1000144 <stvec_handler>
 ...
 1000102:	4321                	c.li	x6,8
 1000104:	10000293          	addi	x5,x0,256
 1000108:	1002b073          	csrrc	x0,sstatus,x5
 100010c:	00000297          	auipc	x5,0x0
 1000110:	01028293          	addi	x5,x5,16 # 100011c <reset_vector+0xdc>
 1000114:	14129073          	csrrw	x0,sepc,x5
 1000118:	10200073          	sret
 100011c:	4185                	c.li	x3,1

0100011e <do_scall>:
 100011e:	00000073          	ecall
 1000122:	a019                	c.j	1000128 <fail>
 1000124:	00301b63          	bne	x0,x3,100013a <pass>

01000128 <fail>:
 1000128:	0ff0000f          	fence	iorw,iorw
 100012c:	00018063          	beq	x3,x0,100012c <fail+0x4>
 1000130:	0186                	c.slli	x3,0x1
 1000132:	0011e193          	ori	x3,x3,1
 1000136:	00000073          	ecall

0100013a <pass>:
 100013a:	0ff0000f          	fence	iorw,iorw
 100013e:	4185                	c.li	x3,1
 1000140:	00000073          	ecall

01000144 <stvec_handler>:
 1000144:	142022f3          	csrrs	x5,scause,x0
 1000148:	fe6290e3          	bne	x5,x6,1000128 <fail>
 100014c:	00000397          	auipc	x7,0x0
 1000150:	fd238393          	addi	x7,x7,-46 # 100011e <do_scall>
 1000154:	141022f3          	csrrs	x5,sepc,x0
 1000158:	fc7298e3          	bne	x5,x7,1000128 <fail>
 100015c:	bff9                	c.j	100013a <pass>
	...
