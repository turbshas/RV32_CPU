...
rv32ui/beq.elf:     file format elf32-littleriscv
...
010000ec <test_2>:
 ...
 10000f2:	00208663          	beq	x1,x2,10000fe <test_2+0x12>
 10000f6:	1c301563          	bne	x0,x3,10002c0 <fail>
 10000fa:	00301663          	bne	x0,x3,1000106 <test_3>
 10000fe:	fe208ee3          	beq	x1,x2,10000fa <test_2+0xe>
...
01000106 <test_3>:
 ...
 100010c:	00208663          	beq	x1,x2,1000118 <test_3+0x12>
 1000110:	1a301863          	bne	x0,x3,10002c0 <fail>
 1000114:	00301663          	bne	x0,x3,1000120 <test_4>
 1000118:	fe208ee3          	beq	x1,x2,1000114 <test_3+0xe>
...
01000192 <test_9>:
 ...
 100019a:	12208363          	beq	x1,x2,10002c0 <fail>
...
010001a6 <test_10>:
 ...
 10001b0:	10208863          	beq	x1,x2,10002c0 <fail>
...
010001bc <test_11>:
 ...
 10001c8:	0e208c63          	beq	x1,x2,10002c0 <fail>
...
010001d4 <test_12>:
 ...
 10001de:	0e208163          	beq	x1,x2,10002c0 <fail>
...
010001ea <test_13>:
 ...
 10001f6:	0c208563          	beq	x1,x2,10002c0 <fail>
...
01000202 <test_14>:
 ...
 100020e:	0a208963          	beq	x1,x2,10002c0 <fail>
...
0100021a <test_15>:
 ...
 1000222:	08208f63          	beq	x1,x2,10002c0 <fail>
...
0100022e <test_16>:
 ...
 1000238:	08208463          	beq	x1,x2,10002c0 <fail>
...
01000244 <test_17>:
 ...
 1000250:	06208863          	beq	x1,x2,10002c0 <fail>
...
0100025c <test_18>:
 ...
 1000266:	04208d63          	beq	x1,x2,10002c0 <fail>
...
01000272 <test_19>:
 ...
 100027e:	04208163          	beq	x1,x2,10002c0 <fail>
...
0100028a <test_20>:
 ...
 1000296:	02208563          	beq	x1,x2,10002c0 <fail>
...
010002a2 <test_21>:
 ...
 10002a4:	00000663          	beq	x0,x0,10002b0 <test_21+0xe>
