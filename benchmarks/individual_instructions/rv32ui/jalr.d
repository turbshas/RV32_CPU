...
rv32ui/jalr.elf:     file format elf32-littleriscv
...
010000ec <test_2>:
 ...
 10000ee:	4281                	c.li	x5,0
 10000f0:	00000317          	auipc	x6,0x0
 10000f4:	00e30313          	addi	x6,x6,14 # 10000fe <target_2>
 10000f8:	000302e7          	jalr	x5,0(x6)

010000fc <linkaddr_2>:
 10000fc:	a045                	c.j	100019c <fail>

010000fe <target_2>:
 10000fe:	00000317          	auipc	x6,0x0
 1000102:	ffe30313          	addi	x6,x6,-2 # 10000fc <linkaddr_2>
 1000106:	08629b63          	bne	x5,x6,100019c <fail>

0100010a <test_4>:
 100010a:	4191                	c.li	x3,4
 100010c:	4201                	c.li	x4,0
 100010e:	00000317          	auipc	x6,0x0
 1000112:	01030313          	addi	x6,x6,16 # 100011e <test_4+0x14>
 1000116:	000306e7          	jalr	x13,0(x6)
 100011a:	08301163          	bne	x0,x3,100019c <fail>
 100011e:	0205                	c.addi	x4,1
 1000120:	4289                	c.li	x5,2
 1000122:	fe5216e3          	bne	x4,x5,100010e <test_4+0x4>

01000126 <test_5>:
 1000126:	4195                	c.li	x3,5
 1000128:	4201                	c.li	x4,0
 100012a:	00000317          	auipc	x6,0x0
 100012e:	01230313          	addi	x6,x6,18 # 100013c <test_5+0x16>
 1000132:	0001                	c.addi	x0,0
 1000134:	000306e7          	jalr	x13,0(x6)
 1000138:	06301263          	bne	x0,x3,100019c <fail>
 100013c:	0205                	c.addi	x4,1
 100013e:	4289                	c.li	x5,2
 1000140:	fe5215e3          	bne	x4,x5,100012a <test_5+0x4>

01000144 <test_6>:
 1000144:	4199                	c.li	x3,6
 1000146:	4201                	c.li	x4,0
 1000148:	00000317          	auipc	x6,0x0
 100014c:	01430313          	addi	x6,x6,20 # 100015c <test_6+0x18>
 1000150:	0001                	c.addi	x0,0
 1000152:	0001                	c.addi	x0,0
 1000154:	000306e7          	jalr	x13,0(x6)
 1000158:	04301263          	bne	x0,x3,100019c <fail>
 100015c:	0205                	c.addi	x4,1
 100015e:	4289                	c.li	x5,2
 1000160:	fe5214e3          	bne	x4,x5,1000148 <test_6+0x4>

01000164 <test_7>:
 1000164:	00100293          	addi	x5,x0,1
 1000168:	00000317          	auipc	x6,0x0
 100016c:	01c30313          	addi	x6,x6,28 # 1000184 <test_7+0x20>
 1000170:	ffc30067          	jalr	x0,-4(x6)
 1000174:	00128293          	addi	x5,x5,1
 1000178:	00128293          	addi	x5,x5,1
 100017c:	00128293          	addi	x5,x5,1
 1000180:	00128293          	addi	x5,x5,1
 1000184:	00128293          	addi	x5,x5,1
 1000188:	00128293          	addi	x5,x5,1
 100018c:	00400e93          	addi	x29,x0,4
 1000190:	00700193          	addi	x3,x0,7
 1000194:	01d29463          	bne	x5,x29,100019c <fail>
 1000198:	00301b63          	bne	x0,x3,10001ae <pass>

0100019c <fail>:
 100019c:	0ff0000f          	fence	iorw,iorw
 10001a0:	00018063          	beq	x3,x0,10001a0 <fail+0x4>
 10001a4:	0186                	c.slli	x3,0x1
 10001a6:	0011e193          	ori	x3,x3,1
 10001aa:	00000073          	ecall

010001ae <pass>:
 10001ae:	0ff0000f          	fence	iorw,iorw
 10001b2:	4185                	c.li	x3,1
 10001b4:	00000073          	ecall
 10001b8:	0000                	c.unimp
 10001ba:	0000                	c.unimp
	...
