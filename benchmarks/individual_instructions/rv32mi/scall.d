...
rv32mi/scall.elf:     file format elf32-littleriscv
...
01000004 <trap_vector>:
 ...
 100001e:	142f0f13          	addi	x30,x30,322 # 100015c <mtvec_handler>
...
01000040 <reset_vector>:
 ...
 10000fa:	4321                	c.li	x6,8
 10000fc:	000022b7          	lui	x5,0x2
 1000100:	80028293          	addi	x5,x5,-2048 # 1800 <_start-0xffe800>
 1000104:	3002b073          	csrrc	x0,mstatus,x5
 1000108:	300023f3          	csrrs	x7,mstatus,x0
 100010c:	0072f2b3          	and	x5,x5,x7
 1000110:	00028363          	beq	x5,x0,1000116 <reset_vector+0xd6>
 1000114:	432d                	c.li	x6,11
 1000116:	000022b7          	lui	x5,0x2
 100011a:	80028293          	addi	x5,x5,-2048 # 1800 <_start-0xffe800>
 100011e:	3002b073          	csrrc	x0,mstatus,x5
 1000122:	00000297          	auipc	x5,0x0
 1000126:	01028293          	addi	x5,x5,16 # 1000132 <reset_vector+0xf2>
 100012a:	34129073          	csrrw	x0,mepc,x5
 100012e:	30200073          	mret
 1000132:	4185                	c.li	x3,1

01000134 <do_scall>:
 1000134:	00000073          	ecall
 1000138:	a019                	c.j	100013e <fail>
 100013a:	00301b63          	bne	x0,x3,1000150 <pass>

0100013e <fail>:
 100013e:	0ff0000f          	fence	iorw,iorw
 1000142:	00018063          	beq	x3,x0,1000142 <fail+0x4>
 1000146:	0186                	c.slli	x3,0x1
 1000148:	0011e193          	ori	x3,x3,1
 100014c:	00000073          	ecall

01000150 <pass>:
 1000150:	0ff0000f          	fence	iorw,iorw
 1000154:	4185                	c.li	x3,1
 1000156:	00000073          	ecall
 100015a:	0001                	c.addi	x0,0

0100015c <mtvec_handler>:
 100015c:	342022f3          	csrrs	x5,mcause,x0
 1000160:	fc629fe3          	bne	x5,x6,100013e <fail>
 1000164:	00000397          	auipc	x7,0x0
 1000168:	fd038393          	addi	x7,x7,-48 # 1000134 <do_scall>
 100016c:	341022f3          	csrrs	x5,mepc,x0
 1000170:	fc7297e3          	bne	x5,x7,100013e <fail>
 1000174:	bff1                	c.j	1000150 <pass>
	...
