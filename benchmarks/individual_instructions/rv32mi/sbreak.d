...
rv32mi/sbreak.elf:     file format elf32-littleriscv
...
01000004 <trap_vector>:
 ...
 100001e:	106f0f13          	addi	x30,x30,262 # 1000120 <mtvec_handler>
...
010000fa <do_break>:
 10000fa:	9002                	c.ebreak
 10000fc:	a019                	c.j	1000102 <fail>
 10000fe:	00301b63          	bne	x0,x3,1000114 <pass>

01000102 <fail>:
 1000102:	0ff0000f          	fence	iorw,iorw
 1000106:	00018063          	beq	x3,x0,1000106 <fail+0x4>
 100010a:	0186                	c.slli	x3,0x1
 100010c:	0011e193          	ori	x3,x3,1
 1000110:	00000073          	ecall

01000114 <pass>:
 1000114:	0ff0000f          	fence	iorw,iorw
 1000118:	4185                	c.li	x3,1
 100011a:	00000073          	ecall
 100011e:	0001                	c.addi	x0,0

01000120 <mtvec_handler>:
 1000120:	430d                	c.li	x6,3
 1000122:	342022f3          	csrrs	x5,mcause,x0
 1000126:	fc629ee3          	bne	x5,x6,1000102 <fail>
 100012a:	00000317          	auipc	x6,0x0
 100012e:	fd030313          	addi	x6,x6,-48 # 10000fa <do_break>
 1000132:	341022f3          	csrrs	x5,mepc,x0
 1000136:	fc6296e3          	bne	x5,x6,1000102 <fail>
 100013a:	bfe9                	c.j	1000114 <pass>
 100013c:	0000                	c.unimp
	...
