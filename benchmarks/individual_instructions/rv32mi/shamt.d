...
rv32mi/shamt.elf:     file format elf32-littleriscv
...
01000004 <trap_vector>:
 ...
 100001e:	116f0f13          	addi	x30,x30,278 # 1000130 <mtvec_handler>
...
01000040 <reset_vector>:
 ...
 10000e8:	01428293          	addi	x5,x5,20 # 10000f8 <test_2>
 10000ec:	34129073          	csrrw	x0,mepc,x5
 10000f0:	f1402573          	csrrs	x10,mhartid,x0
 10000f4:	30200073          	mret

010000f8 <test_2>:
 10000f8:	4505                	c.li	x10,1
 10000fa:	0542                	c.slli	x10,0x10
 10000fc:	6ec1                	c.lui	x29,0x10
 10000fe:	4189                	c.li	x3,2
 1000100:	01d51a63          	bne	x10,x29,1000114 <fail>

01000104 <test_3>:
 1000104:	02051513          	slli	x10,x10,0x20
 1000108:	4e85                	c.li	x29,1
 100010a:	418d                	c.li	x3,3
 100010c:	01d01463          	bne	x0,x29,1000114 <fail>
 1000110:	00301b63          	bne	x0,x3,1000126 <pass>

01000114 <fail>:
 1000114:	0ff0000f          	fence	iorw,iorw
 1000118:	00018063          	beq	x3,x0,1000118 <fail+0x4>
 100011c:	0186                	c.slli	x3,0x1
 100011e:	0011e193          	ori	x3,x3,1
 1000122:	00000073          	ecall

01000126 <pass>:
 1000126:	0ff0000f          	fence	iorw,iorw
 100012a:	4185                	c.li	x3,1
 100012c:	00000073          	ecall

01000130 <mtvec_handler>:
 1000130:	4289                	c.li	x5,2
 1000132:	fe5191e3          	bne	x3,x5,1000114 <fail>
 1000136:	342022f3          	csrrs	x5,mcause,x0
 100013a:	4309                	c.li	x6,2
 100013c:	fc629ce3          	bne	x5,x6,1000114 <fail>
 1000140:	b7dd                	c.j	1000126 <pass>
	...
